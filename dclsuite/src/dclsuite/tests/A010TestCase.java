 ...
 */
public class A010TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A010 cannot-access com.example.b.B010"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A010",accessFieldDependency.getClassNameA());
		assertEquals("com.example.b.B010",accessFieldDependency.getClassNameB());
