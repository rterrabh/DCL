 ...
 */
public class A126TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A126 must-declare com.example.b.B126"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A126",aad.getClassNameA());
		assertEquals("com.example.b.B126",aad.getModuleNameB());
	}
