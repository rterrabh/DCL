 ...
 */
public class A118TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A118 cannot-declare com.example.b.B118"); //Define the constraint to be validated
		...
		//assertEquals("com.example.a.A118",declare[]Dependency.getClassNameA());
		//assertEquals("com.example.c.C118",declare[]Dependency.getClassNameB());
