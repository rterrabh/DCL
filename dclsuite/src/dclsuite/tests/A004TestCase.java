 ...
 */
public class A004TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A004 can-access-only com.example.b.B004"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A004",accessMethodDependency.getClassNameA());
		assertEquals("com.example.c.C004",accessMethodDependency.getClassNameB());
		assertEquals("f",accessMethodDependency.getMethodNameA());
		assertEquals("h",accessMethodDependency.getMethodNameB());
		assertEquals(false,accessMethodDependency.isStaticInvoke());		
	}
