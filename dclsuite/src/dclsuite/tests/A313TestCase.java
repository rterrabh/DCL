 ...
 */
public class A313TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A313 must-extend com.example.b.B313"); //Define the constraint to be validated
		...
		assertEquals(ExtendDependency.class, aad.getViolatedConstraint().getConstraint().getDependencyType().getDependencyClass() ); //Check the type of dependency
		
		//Check each attribute of the violation
		assertEquals("com.example.a.A313",aad.getClassNameA());
		assertEquals("com.example.b.B313",aad.getModuleNameB());
	}
