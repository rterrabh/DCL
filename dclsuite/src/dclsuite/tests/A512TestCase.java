 ...
 */
public class A512TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("only com.example.c.C512 can-useannotation com.example.b.B512"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A512",annotateFieldDependency.getClassNameA());
		assertEquals("com.example.b.B512",annotateFieldDependency.getClassNameB());
	}
