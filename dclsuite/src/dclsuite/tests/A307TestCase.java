 ...
 */
public class A307TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("only com.example.c.C307, com.example.d.D307 can-extend com.example.b.B307"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A307",extendIndirectDependency.getClassNameA());
		assertEquals("com.example.b.B307",extendIndirectDependency.getClassNameB());
	}
