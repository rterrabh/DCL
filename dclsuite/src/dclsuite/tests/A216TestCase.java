 ...
 */
public class A216TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("only com.example.c.C216 can-create com.example.b.B216"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A216",createMethodDependency.getClassNameA());
		assertEquals("com.example.b.B216",createMethodDependency.getClassNameB());
	}
