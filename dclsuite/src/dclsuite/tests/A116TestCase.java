 ...
 */
public class A116TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A116 cannot-declare com.example.b.B116"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A116",declareParameterDependency.getClassNameA());
		assertEquals("com.example.b.B116",declareParameterDependency.getClassNameB());
