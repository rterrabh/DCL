 ...
 */
public class A102TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A102 can-declare-only com.example.b.B102"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A102",declareParameterDependency.getClassNameA());
		assertEquals("com.example.c.C102",declareParameterDependency.getClassNameB());
