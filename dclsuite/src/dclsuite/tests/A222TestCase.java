 ...
 */
public class A222TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A222 cannot-create com.example.b.B222"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A222",createMethodDependency.getClassNameA());
		assertEquals("com.example.b.B222",createMethodDependency.getClassNameB());
	}
