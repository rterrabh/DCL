 ...
 */
public class A225TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A225 cannot-create com.example.b.B225"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A225",createFieldDependency.getClassNameA());
		assertEquals("com.example.b.B225",createFieldDependency.getClassNameB());
	}
