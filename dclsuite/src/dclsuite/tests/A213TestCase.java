 ...
 */
public class A213TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("only com.example.c.C213 can-create com.example.b.B213"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A213",createMethodDependency.getClassNameA());
		assertEquals("com.example.b.B213",createMethodDependency.getClassNameB());
	}
