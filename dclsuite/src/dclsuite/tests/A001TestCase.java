 ...
 */
public class A001TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A001 can-access-only com.example.b.B001, $java"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A001",accessFieldDependency.getClassNameA());
		assertEquals("com.example.c.C001",accessFieldDependency.getClassNameB());
