 ...
 */
public class A217TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("only com.example.c.C217 can-create com.example.b.B217"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A217",createMethodDependency.getClassNameA());
		assertEquals("com.example.b.B217",createMethodDependency.getClassNameB());
	}
