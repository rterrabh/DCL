 ...
 */
public class A404TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("only com.example.c.C404 can-implement com.example.b.B404"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A404",implementDirectDependency.getClassNameA());
		assertEquals("com.example.b.B404",implementDirectDependency.getClassNameB());
	}
