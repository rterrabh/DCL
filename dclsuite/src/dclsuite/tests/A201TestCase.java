 ...
 */
public class A201TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A201 can-create-only com.example.b.B201"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A201",createMethodDependency.getClassNameA());
		assertEquals("com.example.c.C201",createMethodDependency.getClassNameB());
	}
