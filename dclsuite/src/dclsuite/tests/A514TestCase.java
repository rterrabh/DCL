 ...
 */
public class A514TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("only com.example.c.C514 can-useannotation com.example.b.B514"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A514",annotateFormalParamenterDependency.getClassNameA());
		assertEquals("com.example.b.B514",annotateFormalParamenterDependency.getClassNameB());
