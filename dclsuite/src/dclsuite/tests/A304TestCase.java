 ...
 */
public class A304TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A304a, com.example.a.A304b  can-extend-only com.example.b.B304, $java"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A304a",extendDirectDependency.getClassNameA());
		assertEquals("com.example.c.C304",extendDirectDependency.getClassNameB());*/
	}
