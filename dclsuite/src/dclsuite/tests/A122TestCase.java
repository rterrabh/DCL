 ...
 */
public class A122TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A122 must-declare com.example.b.B122"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A122",aad.getClassNameA());
		assertEquals("com.example.b.B122",aad.getModuleNameB());
	}
