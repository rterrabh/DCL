 ...
 */
public class A206TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A206 can-create-only com.example.b.B206"); //Define the constraint to be validated
