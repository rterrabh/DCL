 ...
 */
public class A309TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A309 cannot-extend com.example.b.B309"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A309",extendDirectDependency.getClassNameA());
		assertEquals("com.example.b.B309",extendDirectDependency.getClassNameB());
	}
