 ...
 */
public class A406TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("only com.example.c.C406, com.example.d.D406 can-implement com.example.b.B406"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A406",implementIndirectDependency.getClassNameA());
		assertEquals("com.example.b.B406",implementIndirectDependency.getClassNameB());
	}
