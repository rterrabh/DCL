 ...
 */
public class A229TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A229 cannot-create com.example.b.B229"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A229",createMethodDependency.getClassNameA());
		assertEquals("com.example.b.B229",createMethodDependency.getClassNameB());
	}
