 ...
 */
public class A227TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A227 cannot-create com.example.b.B227"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A227",createMethodDependency.getClassNameA());
		assertEquals("com.example.b.B227",createMethodDependency.getClassNameB());
	}
