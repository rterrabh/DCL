 ...
 */
public class A235TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A235 must-create com.example.b.B235"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A235",aad.getClassNameA());
		assertEquals("com.example.b.B235",aad.getModuleNameB());
	}
