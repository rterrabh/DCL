 ...
 */
public class A509TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("only com.example.c.C509 can-useannotation com.example.b.B509"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A509",annotateMethodDependency.getClassNameA());
		assertEquals("com.example.b.B509",annotateMethodDependency.getClassNameB());*/
	}
