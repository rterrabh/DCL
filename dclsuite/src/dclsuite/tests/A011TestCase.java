 ...
 */
public class A011TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A011 cannot-access com.example.b.B011"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A011",accessMethodDependency.getClassNameA());
		assertEquals("com.example.b.B011",accessMethodDependency.getClassNameB());
