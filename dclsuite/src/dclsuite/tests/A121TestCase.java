 ...
 */
public class A121TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A121 cannot-declare com.example.b.B121"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A121",declareReturnDependency.getClassNameA());
		assertEquals("com.example.b.B121",declareReturnDependency.getClassNameB());
