 ...
 */
public class A308TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("only com.example.c.C308 can-extend com.example.b.B308"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A308",extendDirectDependency.getClassNameA());
		assertEquals("com.example.b.B308",extendDirectDependency.getClassNameB());
	}
