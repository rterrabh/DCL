 ...
 */
public class A303TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A303 can-extend-only com.example.d.D303, com.example.c.C303, $java"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A303",extendIndirectDependency.getClassNameA());
		assertEquals("com.example.b.B303",extendIndirectDependency.getClassNameB());
	}
