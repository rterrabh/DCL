 ...
 */
public class A503TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A503 can-useannotation-only com.example.b.B503"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A503",annotateMethodDependency.getClassNameA());
		assertEquals("com.example.c.C503",annotateMethodDependency.getClassNameB());
	}
