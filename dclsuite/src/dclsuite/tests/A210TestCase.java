 ...
 */
public class A210TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A210 can-create-only com.example.b.B210"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A210",createMethodDependency.getClassNameA());
		assertEquals("com.example.c.C210",createMethodDependency.getClassNameB());
	}
