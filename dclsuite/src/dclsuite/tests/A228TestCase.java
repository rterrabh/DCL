 ...
 */
public class A228TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A228 cannot-create com.example.b.B228"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A228",createMethodDependency.getClassNameA());
		assertEquals("com.example.b.B228",createMethodDependency.getClassNameB());
	}
