 ...
 */
public class A012TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A012 cannot-access com.example.b.B012"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A012",accessMethodDependency.getClassNameA());
		assertEquals("com.example.b.B012",accessMethodDependency.getClassNameB());
