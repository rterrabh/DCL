 ...
 */
public class A015TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A015 must-access com.example.b.B015"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A015",aad.getClassNameA());
		assertEquals("com.example.b.B015",aad.getModuleNameB());
	}
