...
public class A112TestCase extends DCLTestCase { 
	...
	public void test01() throws Exception {
		...
		assertEquals("com.example.a.A112",declareParameterizedTypeDependency.getClassNameA());
		assertEquals("com.example.b.B112",declareParameterizedTypeDependency.getClassNameB());
