 ...
 */
public class A315TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A315 must-extend com.example.b.B315"); //Define the constraint to be validated
