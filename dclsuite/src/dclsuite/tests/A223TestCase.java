 ...
 */
public class A223TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A223 cannot-create com.example.b.B223"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A223",createMethodDependency.getClassNameA());
		assertEquals("com.example.b.B223",createMethodDependency.getClassNameB());
	}
