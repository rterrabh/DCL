 ...
 */
public class A517TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A517 cannot-useannotation com.example.b.B517"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A517",annotateMethodDependency.getClassNameA());
		assertEquals("com.example.b.B517",annotateMethodDependency.getClassNameB());
	}
