 ...
 */
public class A505TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A505 can-useannotation-only com.example.b.B505"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A505",annotateFieldDependency.getClassNameA());
		assertEquals("com.example.c.C505",annotateFieldDependency.getClassNameB());
	}
