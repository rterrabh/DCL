 ...
 */
public class A502TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A502 can-useannotation-only com.example.b.B502"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A502",annotateClassDependency.getClassNameA());
		assertEquals("com.example.c.C502",annotateClassDependency.getClassNameB());
	}
