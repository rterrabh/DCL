 ...
 */
public class A123TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A123 must-declare com.example.b.B123"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A123",aad.getClassNameA());
		assertEquals("com.example.b.B123",aad.getModuleNameB());
	}
