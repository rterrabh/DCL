 ...
 */
public class A523TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A523 must-useannotation com.example.b.B523"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A523",aad.getClassNameA());
		assertEquals("com.example.b.B523",aad.getModuleNameB());
	}
