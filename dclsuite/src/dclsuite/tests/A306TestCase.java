 ...
 */
public class A306TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("only com.example.c.C306 can-extend com.example.b.B306"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A306",extendIndirectDependency.getClassNameA());
		assertEquals("com.example.b.B306",extendIndirectDependency.getClassNameB());
	}
