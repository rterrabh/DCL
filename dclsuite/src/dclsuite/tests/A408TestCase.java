 ...
 */
public class A408TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A408 cannot-implement com.example.b.B408"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A408",implementIndirectDependency.getClassNameA());
		assertEquals("com.example.b.B408",implementIndirectDependency.getClassNameB());
	}
