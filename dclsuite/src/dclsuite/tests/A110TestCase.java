 ...
 */
public class A110TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("only com.example.c.C110 can-declare com.example.b.B110"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A110",declareLocalVariableDependency.getClassNameA());
		assertEquals("com.example.b.B110",declareLocalVariableDependency.getClassNameB());
		
		assertEquals("objA",declareLocalVariableDependency.getFieldName());
