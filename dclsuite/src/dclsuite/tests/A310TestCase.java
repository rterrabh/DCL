 ...
 */
public class A310TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A310 cannot-extend com.example.b.B310"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A310",extendIndirectDependency.getClassNameA());
		assertEquals("com.example.b.B310",extendIndirectDependency.getClassNameB());
	}
