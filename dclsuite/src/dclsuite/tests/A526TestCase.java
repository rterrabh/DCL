 ...
 */
public class A526TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A526 must-useannotation com.example.b.B526"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A526",aad.getClassNameA());
		assertEquals("com.example.b.B526",aad.getModuleNameB());
	}
