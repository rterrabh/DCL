 ...
 */
public class A220TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("only com.example.c.C220 can-create com.example.b.B220"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A220",createMethodDependency.getClassNameA());
		assertEquals("com.example.b.B220",createMethodDependency.getClassNameB());
	}
