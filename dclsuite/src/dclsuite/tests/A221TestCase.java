 ...
 */
public class A221TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A221 cannot-create com.example.b.B221"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A221",createMethodDependency.getClassNameA());
		assertEquals("com.example.b.B221",createMethodDependency.getClassNameB());
	}
