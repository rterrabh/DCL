 ...
 */
public class A209TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A209 can-create-only com.example.b.B209"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A209",createMethodDependency.getClassNameA());
		assertEquals("com.example.c.C209",createMethodDependency.getClassNameB());
	}
