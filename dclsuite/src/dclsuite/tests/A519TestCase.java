 ...
 */
public class A519TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A519 cannot-useannotation com.example.b.B519"); //Define the constraint to be validated
