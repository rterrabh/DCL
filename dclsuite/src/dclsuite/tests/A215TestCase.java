 ...
 */
public class A215TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("only com.example.c.C215 can-create com.example.b.B215"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A215",createFieldDependency.getClassNameA());
		assertEquals("com.example.b.B215",createFieldDependency.getClassNameB());
	}
