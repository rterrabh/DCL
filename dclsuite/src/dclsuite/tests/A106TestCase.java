...
public class A106TestCase extends DCLTestCase { 
	...
	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A106 can-declare-only com.example.b.B106"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A106",declareLocalVariableDependency.getClassNameA());
		assertEquals("com.example.c.C106",declareLocalVariableDependency.getClassNameB());
