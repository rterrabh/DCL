 ...
 */
public class A521TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A521 cannot-useannotation com.example.b.B521"); //Define the constraint to be validated
