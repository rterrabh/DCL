 ...
 */
public class A108TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("only com.example.c.C108 can-declare com.example.b.B108"); //Define the constraint to be validated
