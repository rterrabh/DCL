 ...
 */
public class A205TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A205 can-create-only com.example.b.B205"); //Define the constraint to be validated
		...
		assertEquals(CreateFieldDependency.class, dad.getForbiddenDependency().getClass()); //Check the type of dependency
		CreateFieldDependency createFieldDependency = (CreateFieldDependency) dad.getForbiddenDependency();

		
		//Check each attribute of the violation
		assertEquals("com.example.a.A205",createFieldDependency.getClassNameA());
		assertEquals("com.example.c.C205",createFieldDependency.getClassNameB());
	}
