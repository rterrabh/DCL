 ...
 */
public class A124TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A124 must-declare com.example.b.B124"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A124",aad.getClassNameA());
		assertEquals("com.example.b.B124",aad.getModuleNameB());
	}
