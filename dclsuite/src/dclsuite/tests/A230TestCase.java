 ...
 */
public class A230TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A230 cannot-create com.example.b.B230"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A230",createMethodDependency.getClassNameA());
		assertEquals("com.example.b.B230",createMethodDependency.getClassNameB());
	}
