 ...
 */
public class A212TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("only com.example.c.C212 can-create com.example.b.B212"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A212",createMethodDependency.getClassNameA());
		assertEquals("com.example.b.B212",createMethodDependency.getClassNameB());
	}
