 ...
 */
public class A522TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A522 must-useannotation com.example.b.B522"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A522",aad.getClassNameA());
		assertEquals("com.example.b.B522",aad.getModuleNameB());
	}
