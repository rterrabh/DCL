 ...
 */
public class A510TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("only com.example.c.C510 can-useannotation com.example.b.B510"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A510",annotateMethodDependency.getClassNameA());
		assertEquals("com.example.b.B510",annotateMethodDependency.getClassNameB());
	}
