 ...
 */
public class A009TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A009 cannot-access com.example.b.B009"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A009",accessFieldDependency.getClassNameA());
		assertEquals("com.example.b.B009",accessFieldDependency.getClassNameB());
