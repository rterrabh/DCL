 ...
 */
public class A103TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A103 can-declare-only com.example.b.B103"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A103",declareLocalVariableDependency.getClassNameA());
		assertEquals("com.example.c.C103",declareLocalVariableDependency.getClassNameB());
		
		assertEquals("objC",declareLocalVariableDependency.getFieldName());
