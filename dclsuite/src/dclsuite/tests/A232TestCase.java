 ...
 */
public class A232TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A232 must-create com.example.b.B232"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A232",aad.getClassNameA());
		assertEquals("com.example.b.B232",aad.getModuleNameB());
	}
