 ...
 */
public class A506TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A506 can-useannotation-only com.example.b.B506, java.lang.SuppressWarnings"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A506",annotateVariableDependency.getClassNameA());
		assertEquals("com.example.c.C506",annotateVariableDependency.getClassNameB());
		assertEquals("f",annotateVariableDependency.getMethodNameA());
		assertEquals("var",annotateVariableDependency.getVariableNameA());
	}
