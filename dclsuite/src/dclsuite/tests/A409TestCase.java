 ...
 */
public class A409TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A409 cannot-implement com.example.b.B409"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A409",implementIndirectDependency.getClassNameA());
		assertEquals("com.example.b.B409",implementIndirectDependency.getClassNameB());
	}
