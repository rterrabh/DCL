 ...
 */
public class A218TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("only com.example.c.C218 can-create com.example.b.B218"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A218",createMethodDependency.getClassNameA());
		assertEquals("com.example.b.B218",createMethodDependency.getClassNameB());
	}
