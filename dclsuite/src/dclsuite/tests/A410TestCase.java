 ...
 */
public class A410TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A410 must-implement com.example.b.B410"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A410",aad.getClassNameA());
