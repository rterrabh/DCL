 ...
 */
public class A016TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A016 must-access com.example.b.B016"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A016",aad.getClassNameA());
		assertEquals("com.example.b.B016",aad.getModuleNameB());
	}
