 ...
 */
public class A233TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A233 must-create com.example.b.B233"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A233",aad.getClassNameA());
		assertEquals("com.example.b.B233",aad.getModuleNameB());
	}
