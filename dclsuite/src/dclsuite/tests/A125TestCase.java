 ...
 */
public class A125TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A125 must-declare com.example.b.B125"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A125",aad.getClassNameA());
		assertEquals("com.example.b.B125",aad.getModuleNameB());
	}
