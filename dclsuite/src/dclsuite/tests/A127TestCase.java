 ...
 */
public class A127TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A127 must-declare com.example.b.B127"); //Define the constraint to be validated
		...
		assertEquals(DeclareDependency.class, aad.getViolatedConstraint().getConstraint().getDependencyType().getDependencyClass() ); //Check the type of dependency
		
		//Check each attribute of the violation
		assertEquals("com.example.a.A127",aad.getClassNameA());
		assertEquals("com.example.b.B127",aad.getModuleNameB());
	}
