 ...
 */
public class A511TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("only com.example.c.C511 can-useannotation com.example.b.B511"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A511",annotateMethodDependency.getClassNameA());
		assertEquals("com.example.b.B511",annotateMethodDependency.getClassNameB());
	}
