 ...
 */
public class A211TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("only com.example.c.C211 can-create com.example.b.B211"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A211",createMethodDependency.getClassNameA());
		assertEquals("com.example.b.B211",createMethodDependency.getClassNameB());
	}
