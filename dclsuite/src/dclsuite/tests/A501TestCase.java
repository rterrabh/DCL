 ...
 */
public class A501TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A501 can-useannotation-only com.example.b.B501"); //Define the constraint to be validated
