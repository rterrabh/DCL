 ...
 */
public class A214TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("only com.example.c.C214 can-create com.example.b.B214"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A214",createMethodDependency.getClassNameA());
		assertEquals("com.example.b.B214",createMethodDependency.getClassNameB());
	}
