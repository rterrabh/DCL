 ...
 */
public class A207TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A207 can-create-only com.example.b.B207"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A207",createMethodDependency.getClassNameA());
		assertEquals("com.example.c.C207",createMethodDependency.getClassNameB());
	}
