 ...
 */
public class A003TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A003 can-access-only com.example.b.B003"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A003",accessMethodDependency.getClassNameA());
		assertEquals("com.example.c.C003",accessMethodDependency.getClassNameB());
