 ...
 */
public class A525TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A525 must-useannotation com.example.b.B525"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A525",aad.getClassNameA());
		assertEquals("com.example.b.B525",aad.getModuleNameB());
	}
