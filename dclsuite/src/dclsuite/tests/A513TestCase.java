 ...
 */
public class A513TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("only com.example.c.C513 can-useannotation com.example.b.B513"); //Define the constraint to be validated
