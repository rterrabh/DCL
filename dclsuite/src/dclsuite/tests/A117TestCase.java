 ...
 */
public class A117TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A117 cannot-declare com.example.b.B117"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A117",declareLocalVariableDependency.getClassNameA());
		assertEquals("com.example.b.B117",declareLocalVariableDependency.getClassNameB());
