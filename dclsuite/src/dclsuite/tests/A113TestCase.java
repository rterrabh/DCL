...
public class A113TestCase extends DCLTestCase { 
	...
	public void test01() throws Exception {
		...
		assertEquals("com.example.a.A113",declareLocalVariableDependency.getClassNameA());
		assertEquals("com.example.b.B113",declareLocalVariableDependency.getClassNameB());
