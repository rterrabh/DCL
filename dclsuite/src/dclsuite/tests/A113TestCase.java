...
public class A113TestCase extends DCLTestCase { 
	...
	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("only com.example.a.A113 can-declare com.example.b.B113"); //Define the constraint to be validated
		...
		//assertEquals("com.example.a.A113",declare[]Dependency.getClassNameA());
		//assertEquals("com.example.c.C113",declare[]Dependency.getClassNameB());
