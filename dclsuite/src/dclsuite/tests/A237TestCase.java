 ...
 */
public class A237TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A237 must-create com.example.b.B237"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A237",aad.getClassNameA());
		assertEquals("com.example.b.B237",aad.getModuleNameB());
	}
