 ...
 */
public class A005TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("only com.example.c.C005 can-access com.example.b.B005"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A005",accessFieldDependency.getClassNameA());
		assertEquals("com.example.b.B005",accessFieldDependency.getClassNameB());
