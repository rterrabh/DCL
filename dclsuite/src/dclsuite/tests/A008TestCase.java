 ...
 */
public class A008TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("only com.example.c.C008 can-access com.example.b.B008"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A008",accessMethodDependency.getClassNameA());
		assertEquals("com.example.b.B008",accessMethodDependency.getClassNameB());
