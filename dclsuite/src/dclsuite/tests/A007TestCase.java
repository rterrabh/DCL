 ...
 */
public class A007TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("only com.example.c.C007 can-access com.example.b.B007"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A007",accessMethodDependency.getClassNameA());
		assertEquals("com.example.b.B007",accessMethodDependency.getClassNameB());
