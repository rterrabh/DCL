 ...
 */
public class A515TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A515 cannot-useannotation com.example.b.B515"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A515",annotateMethodDependency.getClassNameA());
		assertEquals("com.example.b.B515",annotateMethodDependency.getClassNameB());*/
	}
