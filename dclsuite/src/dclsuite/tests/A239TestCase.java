 ...
 */
public class A239TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A239 must-create com.example.b.B239"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A239",aad.getClassNameA());
		assertEquals("com.example.b.B239",aad.getModuleNameB());
	}
