 ...
 */
public class A527TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A527 must-useannotation com.example.b.B527"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A527",aad.getClassNameA());
		assertEquals("com.example.b.B527",aad.getModuleNameB());
	}
