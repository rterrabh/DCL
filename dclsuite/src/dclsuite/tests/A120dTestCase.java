...
public class A120dTestCase extends DCLTestCase { 
	...
	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A120d cannot-declare com.example.b.B120"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A120d",declareParameterizedTypeDependency.getClassNameA());
