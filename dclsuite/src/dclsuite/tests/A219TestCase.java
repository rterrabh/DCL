 ...
 */
public class A219TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("only com.example.c.C219 can-create com.example.b.B219"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A219",createMethodDependency.getClassNameA());
		assertEquals("com.example.b.B219",createMethodDependency.getClassNameB());
	}
