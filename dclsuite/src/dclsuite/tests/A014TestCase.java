 ...
 */
public class A014TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A014 must-access com.example.b.B014"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A014",aad.getClassNameA());
		assertEquals("com.example.b.B014",aad.getModuleNameB());
	}
