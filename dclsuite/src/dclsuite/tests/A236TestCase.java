 ...
 */
public class A236TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A236 must-create com.example.b.B236"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A236",aad.getClassNameA());
		assertEquals("com.example.b.B236",aad.getModuleNameB());
	}
