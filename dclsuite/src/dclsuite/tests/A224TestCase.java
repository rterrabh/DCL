 ...
 */
public class A224TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A224 cannot-create com.example.b.B224"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A224",createMethodDependency.getClassNameA());
		assertEquals("com.example.b.B224",createMethodDependency.getClassNameB());
	}
