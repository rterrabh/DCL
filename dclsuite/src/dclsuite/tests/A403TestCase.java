 ...
 */
public class A403TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A403 can-implement-only com.example.d.D403, com.example.c.C403"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A403",implementIndirectDependency.getClassNameA());
		assertEquals("com.example.b.B403",implementIndirectDependency.getClassNameB());
	}
