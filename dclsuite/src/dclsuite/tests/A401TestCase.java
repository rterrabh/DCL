 ...
 */
public class A401TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A401 can-implement-only com.example.b.B401"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A401",implementDirectDependency.getClassNameA());
		assertEquals("com.example.c.C401",implementDirectDependency.getClassNameB());
	}
