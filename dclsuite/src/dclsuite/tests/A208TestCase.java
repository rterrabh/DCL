 ...
 */
public class A208TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A208 can-create-only com.example.b.B208"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A208",createMethodDependency.getClassNameA());
		assertEquals("com.example.c.C208",createMethodDependency.getClassNameB());
	}
