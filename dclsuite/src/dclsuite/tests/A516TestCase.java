 ...
 */
public class A516TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A516 cannot-useannotation com.example.b.B516"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A516",annotateMethodDependency.getClassNameA());
		assertEquals("com.example.b.B516",annotateMethodDependency.getClassNameB());*/
	}
