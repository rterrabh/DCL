 ...
 */
public class A119TestCase extends DCLTestCase { 
	...
	public void test01() throws Exception {
		...
		//assertEquals("com.example.a.A119",declare[]Dependency.getClassNameA());
		//assertEquals("com.example.c.C119",declare[]Dependency.getClassNameB());
