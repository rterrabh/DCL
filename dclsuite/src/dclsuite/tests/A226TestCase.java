 ...
 */
public class A226TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A226 cannot-create com.example.b.B226"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A226",createMethodDependency.getClassNameA());
		assertEquals("com.example.b.B226",createMethodDependency.getClassNameB());
	}
