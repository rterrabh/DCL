 ...
 */
public class A240TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A240 must-create com.example.b.B240"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A240",aad.getClassNameA());
		assertEquals("com.example.b.B240",aad.getModuleNameB());
	}
