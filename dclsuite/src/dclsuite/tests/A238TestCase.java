 ...
 */
public class A238TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A238 must-create com.example.b.B238"); //Define the constraint to be validated
		...
		assertEquals(CreateDependency.class, aad.getViolatedConstraint().getConstraint().getDependencyType().getDependencyClass() ); //Check the type of dependency
		
		//Check each attribute of the violation
		assertEquals("com.example.a.A238",aad.getClassNameA());
		assertEquals("com.example.b.B238",aad.getModuleNameB());
	}
