...
public class A120bTestCase extends DCLTestCase { 
	...
	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A120b cannot-declare com.example.b.B120"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A120b",declareParameterizedTypeDependency.getClassNameA());
