 ...
 */
public class A410bTestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A410b must-implement com.example.b.B410"); //Define the constraint to be validated
		...
		assertEquals(ImplementDependency.class, aad.getViolatedConstraint().getConstraint().getDependencyType().getDependencyClass() ); //Check the type of dependency
		
		//Check each attribute of the violation
		assertEquals("com.example.a.A410b",aad.getClassNameA());
		assertEquals("com.example.b.B410",aad.getModuleNameB());
	}
