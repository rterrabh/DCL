 ...
 */
public class A524TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A524 must-useannotation com.example.b.B524"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A524",aad.getClassNameA());
		assertEquals("com.example.b.B524",aad.getModuleNameB());
	}
