 ...
 */
public class A128TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A128 must-declare com.example.b.B128"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A128",aad.getClassNameA());
		assertEquals("com.example.b.B128",aad.getModuleNameB());
	}
