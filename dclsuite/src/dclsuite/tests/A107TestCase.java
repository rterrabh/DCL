 ...
 */
public class A107TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A107 can-declare-only com.example.b.B107"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A107",declareReturnDependency.getClassNameA());
		assertEquals("com.example.c.C107",declareReturnDependency.getClassNameB());
